...
public class AuthenticationFilter implements Filter {
    ...
    // This method called as Dependency injection
    ...
    private void executeFilterLogic(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        //logger does loginning the user and printing to console 
    ...
    private void setCORSHeaders(HttpServletRequest request, HttpServletResponse response) {
       response.setHeader("Allow-Control-Allow-Origin", ALLOWED_ORIGIN);
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		private void executeFilterLogic(ServletRequest request, ServletResponse response, FilterChain chain) 
			...
			throws IOException, ServletException {
				...
				// NEW: check if token exists in DB
				if (authService.findTokenInDB(token).isEmpty()) {
				    sendErrorResponse(httpResponse, HttpServletResponse.SC_UNAUTHORIZED, "Unauthorized: Token is no longer valid (logged out)");
				    return;
				}
